  ...
  return {
    ...
    link: function(scope, element, attrs, accordionCtrl) {
      ...
      accordionCtrl.addGroup(scope);
                                                                      ...
                                                                      scope.color0 ="#333333";
                                                                      scope.color1 ="#000000";
                                                                      scope.borderLeft="5px solid #0088cc";
                                                                      scope.imgsrc0 = 'images/reviews/downArrow.png';
                                                                      scope.imgsrc1 = 'images/Up_Arrow.png';
                                                                      scope.isOpen = false;
                                                                      ...
                                                                      scope.$watch('isOpen', function(value) {
                                                                                   if ( value ) {
                                                                                   scope.imgsrc = scope.imgsrc1;
                                                                                   scope.bgcolor = '#FFFFFF';
                                                                                   scope.border=scope.borderLeft;
                                                                                   scope.color=scope.color1;
                                                                                   accordionCtrl.closeOthers(scope);
                                                                                   }else{
                                                                                   scope.bgcolor = '#F0F0F0';
                                                                                   scope.border="";
                                                                                   scope.imgsrc = scope.imgsrc0;
                                                                                   scope.color= scope.color0;                                                                                   }        if ( setIsOpen ) {
...
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache){
  $templateCache.put("template/accordion/accordion-group.html",
    ...
    " <div style='background-color:{{bgcolor}}' class=\"accordion-heading\" ><a style='text-decoration: none;color: {{color}};border-left:{{border}};'class=\"accordion-toggle\" ng-click=\"isOpen = !isOpen\">{{heading}} <img style='float: right;max-height: 15px;max-width:15px;' ng-src=\"{{imgsrc}}\"> </a></div>" +
